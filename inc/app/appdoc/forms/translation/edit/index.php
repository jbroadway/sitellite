...
class AppdocTranslationEditForm extends MailForm {
	function AppdocTranslationEditForm () {
		parent::MailForm ();

		$this->parseSettings ('inc/app/appdoc/forms/translation/edit/settings.php');
