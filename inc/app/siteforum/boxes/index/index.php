...
echo template_simple (
	...
	array (
		...
		'today' => db_shift ('select count(*) from siteforum_post where ts >= ?', date('Y-m-d 00:00:00')),
		'week' => db_shift ('select count(*) from siteforum_post where ts >= ?', date ('Y-m-d 00:00:00', time () - 604800)),
		'guests' => $guests,
	)
);
