...
// +----------------------------------------------------------------------+
//
// Forumbox widget.  Displays an HTML <textarea> form field.
//
...
/**
	 ...
	 * <?php
	 * 
	 * $widget = new MF_Widget_forumbox ('name');
	 ...
	 * @version	1.0, 2001-11-28, $Id: Forumbox.php,v 1.1 2004/06/04 16:31:53 lux Exp $
	 * @access	public
	 * 
	 */

class MF_Widget_forumbox extends MF_Widget {
	/**
