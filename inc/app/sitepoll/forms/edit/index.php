...
class SitepollEditForm extends MailForm {
	function SitepollEditForm () {
		parent::MailForm ();

		loader_import ('saf.GUI.Menu');
		
		$this->parseSettings ('inc/app/sitepoll/forms/edit/settings.php');

		global $page, $cgi;
		
		page_title (intl_get ('Editing Poll') . ': ' . $cgi->_key);
	...
	function onSubmit ($vals) {
		...
		if (! $res) {
			...
			header ('Location: ' . site_prefix () . '/index/sitepoll-details-action/id.' . $key);
			exit;
		}
	}
}
