...
alt                     = "Path to the wvHtml command, used by<br />the Word Importer.<br /><span style='font-weight: normal'>Example: <tt>/usr/local/bin/wvHtml</tt><br />You can download the wvWare package <a href='http://sourceforge.net/projects/wvware' target='_blank'>here</a></span>"
