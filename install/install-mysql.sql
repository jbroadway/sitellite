...
--
-- Structure de la table `sitellite_translation_sv`
--
...
insert into `sitellite_translation` (`id`, `collection`, `pkey`, `lang`, `ts`, `expired`, `sitellite_status`, `title`, `data`) values
(1, 'sitellite_page', 'getting-started', 'fr', '2009-08-18 16:06:06', 'no', 'approved', 'DÃ©buter', 'a:2:{s:5:"title";s:8:"DÃ©buter";s:4:"body";s:3361:"<p>Maintenant que vous avez installÃ© Sitellite avec succÃ¨s, la prochaine Ã©tape est de vous connecter en tant qu''administrateur afin de vous familiariser avec le logiciel. Pour vous connecter, vous pouvez entrer votre nom d''usager et votre mot de passe d''administrateur dans le formulaire pour les membres sur le cÃ´tÃ© de la page, ou bien vous pouvez accÃ©der Ã  la page de connection en ajoutant "/sitellite" Ã  l''adresse de votre site web.</p>\r\n<p>Lors de la premiÃ¨re installation de Sitellite, un usager "admin" est crÃ©er avec le mot de passe spÃ©cifiÃ© lors de la procÃ©dure d''installation.</p>\r\n<h2>Vue web</h2>\r\n<p>La vue web est le premier endroit que vous verrez une fois connectÃ© Ã  Sitellite. C''est une vue de votre site web (le site d''example de Sitellite, dans notre cas), Ã  laquelle sont ajoutÃ©s de petits boutons Ã  divers endroits sur la page. Ces boutons sont utilisÃ©s pour Ã©diter le contenu d''une section donnÃ©e de la page, par exemple le corps principal de la page, ou le texte d''un panneau latÃ©ral.</p>\r\n<p>Dans leur ordre d''apparition, les boutons sont utilisÃ©s pour:</p>\r\n<ul><li>Ajouter un nouveau contenu</li>\r\n<li>Ã‰diter le contenu actuel</li>\r\n<li>Visualiser les modifications faites au contenu actuel</li>\r\n<li>Effacer le contenu actuel</li>\r\n</ul>\r\n<p>La vue web rend la modification de votre site web aussi aisÃ©e que sa navigation, en utilisant le site web lui-mÃªme pour accÃ©der au contenu que vous dÃ©sirez modifier. Parfois cependant, vous aurez besoin de modifier du contenu qui n''est pas visible sur votre site web; par exemple, un fichier vers lequel ne pointe encore aucun lien. Pour cela, Sitellite offre une seconde vue, appelÃ©e le tableau de bord.</p>\r\n<h2>Tableau de bord</h2>\r\n<p>Le tableau de bord donne accÃ¨s Ã  toutes les fonctions de Sitellite. Ses principales composantes sont trois menus, appelÃ©s contenu, administration et outils, une boÃ®te de rÃ©ception et des favoris.</p>\r\n<p>Le menu contenu vous permet de naviguer et de chercher du contenu selon son type. Vous sÃ©lectionnez d''abord le type de contenu Ã  partir de la liste, puis Sitellite vous affiche une liste de contenus de ce type. Ã€ partir de lÃ , vous pouvez trouver un contenu spÃ©cifique en utilisant les paramÃ¨tres de recherche disponibles.</p>\r\n<p>Le menu administration donne accÃ¨s Ã  toutes les tÃ¢ches administratives de Sitellite, comme la gestion des comptes usagers et des paramÃ¨tres du site web. Prenez note que chaque item de ce menu peut Ãªtre bloquÃ© selon les privilÃ¨ge de l''usager connectÃ©, de sorte que seuls les usagers appropriÃ©s puissent crÃ©er de nouveaux comptes usagers.</p>\r\n<p>Le menu outils donne accÃ¨s Ã  une liste de modules et de greffons installÃ©s et vous permet d''y accÃ©der par un clic de souris. Ces outils peuvent inclure des greffons des versions gratuite ou professionnelle de Sitellite.</p>\r\n<p>Sous ces menus, la boÃ®te de rÃ©ception fournit un systÃ¨me de messagerie interne pour l''envoie de messages entre les usagers du systÃ¨me. Il est aussi possible de rediriger automatiquement ces messages Ã  une adresse courriel externe.</p>\r\n<p>Les favoris sont une liste de paramÃ¨tres de recherche enregistrÃ©s pour le contenu se retrouvant dans le menu contenu. Ils permettent d''effectuer des recherches sans entrer Ã  nouveau chaque fois les mÃªmes paramÃ¨tres de recherche.<br />\r\n</p>\r\n";}'),
(2, 'sitellite_page', 'sitemap', 'fr', '2009-08-18 19:53:14', 'no', 'approved', 'Plan du site', 'a:2:{s:5:"title";s:12:"Plan du site";s:4:"body";s:8:"<br />\r\n";}'),
(3, 'sitellite_sidebar', 'members', 'fr', '2009-08-18 19:53:41', 'no', 'approved', 'Membres', 'a:3:{s:5:"title";s:7:"Membres";s:8:"position";s:4:"left";s:4:"body";s:8:"<br />\r\n";}'),
(4, 'sitellite_page', 'index', 'fr', '2009-08-25 12:39:42', 'no', 'approved', 'Accueil', 'a:4:{s:5:"title";s:24:"Bienvenue sur Sitellite!";s:9:"nav_title";s:7:"Accueil";s:11:"description";s:55:"Bienvenue sur votre nouvelle installation de Sitellite.";s:4:"body";s:931:"<p>Si vous lisez ceci, cela signifie que vous avez correctement installÃ© le systÃ¨me de gestion de contenu (SGC) Sitellite, une puissante plateforme PHP pour la gestion de contenu et le dÃ©veloppement d''applications web. Ceci est le site web exemple qui est installÃ© avec le SGC Sitellite. Son but est de fournir une instroduction au systÃ¨me et de vous aider Ã  franchir les prochaines Ã©tapes vers la rÃ©alisation d''un vÃ©ritable site web fonctionnant sous Sitellite.</p>\r\n\r\n<p>Pour commencer Ã  Ã©diter votre site web, entrez dans la boÃ®te qui se trouve Ã  gauche, le nom d''usager "admin" et le mot de passe que vous avez choisi durant l''installation. L''interface complÃ¨te de Sitellite apparaÃ®tra. Vous pouvez aussi vous connecter en allant Ã  "www.example.com/sitellite" sur votre site web.</p>\r\n\r\n<p>Nous espÃ©rons que vous apprÃ©cierez votre visite de Sitellite.</p>\r\n\r\n<p>-- L''Ã©quipe Simian<br />\r\n\r\n</p>\r\n\r\n<br />\r\n\r\n";}'),
(5, 'sitellite_sidebar', 'support', 'fr', '2009-08-18 20:04:44', 'no', 'approved', 'Des questions?', 'a:3:{s:5:"title";s:14:"Des questions?";s:8:"position";s:4:"left";s:4:"body";s:172:"<p>Envoyez-nous un courriel Ã  <a href="mailto:info@simian.ca">info@simian.ca</a>, ou tÃ©lÃ©phonez au 1-204-221-6837 entre 9h et 17h CST, du lundi au vendredi<br />\r\n</p>\r\n";}'),
(6, 'sitellite_page', 'next', 'fr', '2009-08-25 15:12:33', 'no', 'approved', 'Pour poursuivre...', 'a:2:{s:5:"title";s:18:"Pour poursuivre...";s:4:"body";s:2373:"<p>Maintenant que vous avez rÃ©ussi Ã  installer correctement le SGC Sitellite et que vous avez pu vous familiariser avec son fonctionnement, vous devez vous demander: qu''est-ce que je fais maintenant?</p>\r\n<p>Ne vous en faites pas, nous avons prÃ©parÃ© pour vous une liste qui devrait vous aider Ã  dÃ©marrer le plus rapidement possible.</p>\r\n<h2><a href="http://www.sitellite.org/" target="_blank">Visitez Sitellite.org\r\n    </a></h2>\r\n<p>C''est le site officiel de Sitellite, sur lequel vous trouverez des ressources telles:</p>\r\n<ul><li>Le manuel de l''utilisateur de Sitellite, qui contient plusieurs pages de documentation professionnelle pour l''usager, et des exemples introductifs pas-Ã -pas.</li>\r\n<li>Des tutoriels, des cours et plus encore, pour aider les designers et les dÃ©veloppeurs Ã  construire de super sites web en utilisant Sitellite. Les tutoriels sont adaptÃ©s Ã  des niveaux qui vont du dÃ©butant Ã  l''expert.</li>\r\n<li>Des nouvelles sur les produits pour Ãªtre mis au courant quand de nouvelles versions et de nouveaux dÃ©veloppements de Sitellite surviennent.</li>\r\n<li>Des forums de discussion oÃ¹ vous pouvez joindre des conversations actives avec d''autres usagers de SItellite, pour obtenir de l''aide rapidement, ou simplement pour partager des idÃ©es.</li>\r\n<li>Des outils et des produits tiers pour augmenter les capacitÃ©s de SItellite de maniÃ¨re toujours croissante.</li>\r\n</ul>\r\n<h2><a href="http://www.simian.ca/" target="_blank">Visitez Simian Systems\r\n    </a></h2>\r\n<p>Nous sommes la compagnie se trouvant derriÃ¨re Sitellite. Nous sommes lÃ  pour vous fournir un large Ã©ventail de services et de produits spÃ©cialisÃ©s, incluant:</p>\r\n<ul><li>Forfaits de support technique aux heures ouvrables ou 24x7.</li>\r\n<li>Formation sur des sujets tels Sitellite, la gestion de contenu, Linux/Apache/MySQL/PHP, la sÃ©curitÃ© des applications web, les standards web, et plus encore.</li>\r\n<li>Des services de personalisation et de dÃ©veloppement -- qui de mieux placÃ©s que les dÃ©veloppeurs de Sitellite pour vous aider Ã  dÃ©velopper la prochaine application du tonnerre?</li>\r\n<li>Licences commerciales et Ã©dition entreprise du systÃ¨me de gestion de contenu Sitellite, pour les revendeurs et les dÃ©veloppeurs d''applications qui ne veulent pas Ãªtre restreints par les temes de licence GPL.</li>\r\n<li>Et plus...<br />\r\n</li>\r\n</ul>\r\n<br />\r\n";}');
...
insert into `sitellite_translation_sv` (`sv_autoid`, `sv_author`, `sv_action`, `sv_revision`, `sv_changelog`, `sv_deleted`, `sv_current`, `id`, `collection`, `pkey`, `lang`, `ts`, `expired`, `sitellite_status`, `title`, `data`) values
(1, 'admin', 'created', '2009-08-18 16:06:06', '', 'no', 'yes', 1, 'sitellite_page', 'getting-started', 'fr', '2009-08-18 16:06:06', 'no', 'approved', 'DÃ©buter', 'a:2:{s:5:"title";s:8:"DÃ©buter";s:4:"body";s:3361:"<p>Maintenant que vous avez installÃ© Sitellite avec succÃ¨s, la prochaine Ã©tape est de vous connecter en tant qu''administrateur afin de vous familiariser avec le logiciel. Pour vous connecter, vous pouvez entrer votre nom d''usager et votre mot de passe d''administrateur dans le formulaire pour les membres sur le cÃ´tÃ© de la page, ou bien vous pouvez accÃ©der Ã  la page de connection en ajoutant "/sitellite" Ã  l''adresse de votre site web.</p>\r\n<p>Lors de la premiÃ¨re installation de Sitellite, un usager "admin" est crÃ©er avec le mot de passe spÃ©cifiÃ© lors de la procÃ©dure d''installation.</p>\r\n<h2>Vue web</h2>\r\n<p>La vue web est le premier endroit que vous verrez une fois connectÃ© Ã  Sitellite. C''est une vue de votre site web (le site d''example de Sitellite, dans notre cas), Ã  laquelle sont ajoutÃ©s de petits boutons Ã  divers endroits sur la page. Ces boutons sont utilisÃ©s pour Ã©diter le contenu d''une section donnÃ©e de la page, par exemple le corps principal de la page, ou le texte d''un panneau latÃ©ral.</p>\r\n<p>Dans leur ordre d''apparition, les boutons sont utilisÃ©s pour:</p>\r\n<ul><li>Ajouter un nouveau contenu</li>\r\n<li>Ã‰diter le contenu actuel</li>\r\n<li>Visualiser les modifications faites au contenu actuel</li>\r\n<li>Effacer le contenu actuel</li>\r\n</ul>\r\n<p>La vue web rend la modification de votre site web aussi aisÃ©e que sa navigation, en utilisant le site web lui-mÃªme pour accÃ©der au contenu que vous dÃ©sirez modifier. Parfois cependant, vous aurez besoin de modifier du contenu qui n''est pas visible sur votre site web; par exemple, un fichier vers lequel ne pointe encore aucun lien. Pour cela, Sitellite offre une seconde vue, appelÃ©e le tableau de bord.</p>\r\n<h2>Tableau de bord</h2>\r\n<p>Le tableau de bord donne accÃ¨s Ã  toutes les fonctions de Sitellite. Ses principales composantes sont trois menus, appelÃ©s contenu, administration et outils, une boÃ®te de rÃ©ception et des favoris.</p>\r\n<p>Le menu contenu vous permet de naviguer et de chercher du contenu selon son type. Vous sÃ©lectionnez d''abord le type de contenu Ã  partir de la liste, puis Sitellite vous affiche une liste de contenus de ce type. Ã€ partir de lÃ , vous pouvez trouver un contenu spÃ©cifique en utilisant les paramÃ¨tres de recherche disponibles.</p>\r\n<p>Le menu administration donne accÃ¨s Ã  toutes les tÃ¢ches administratives de Sitellite, comme la gestion des comptes usagers et des paramÃ¨tres du site web. Prenez note que chaque item de ce menu peut Ãªtre bloquÃ© selon les privilÃ¨ge de l''usager connectÃ©, de sorte que seuls les usagers appropriÃ©s puissent crÃ©er de nouveaux comptes usagers.</p>\r\n<p>Le menu outils donne accÃ¨s Ã  une liste de modules et de greffons installÃ©s et vous permet d''y accÃ©der par un clic de souris. Ces outils peuvent inclure des greffons des versions gratuite ou professionnelle de Sitellite.</p>\r\n<p>Sous ces menus, la boÃ®te de rÃ©ception fournit un systÃ¨me de messagerie interne pour l''envoie de messages entre les usagers du systÃ¨me. Il est aussi possible de rediriger automatiquement ces messages Ã  une adresse courriel externe.</p>\r\n<p>Les favoris sont une liste de paramÃ¨tres de recherche enregistrÃ©s pour le contenu se retrouvant dans le menu contenu. Ils permettent d''effectuer des recherches sans entrer Ã  nouveau chaque fois les mÃªmes paramÃ¨tres de recherche.<br />\r\n</p>\r\n";}'),
(2, 'admin', 'created', '2009-08-18 19:53:14', '', 'no', 'yes', 2, 'sitellite_page', 'sitemap', 'fr', '2009-08-18 19:53:14', 'no', 'approved', 'Plan du site', 'a:2:{s:5:"title";s:12:"Plan du site";s:4:"body";s:8:"<br />\r\n";}'),
(3, 'admin', 'created', '2009-08-18 19:53:41', '', 'no', 'yes', 3, 'sitellite_sidebar', 'members', 'fr', '2009-08-18 19:53:41', 'no', 'approved', 'Membres', 'a:3:{s:5:"title";s:7:"Membres";s:8:"position";s:4:"left";s:4:"body";s:8:"<br />\r\n";}'),
(4, 'admin', 'modified', '2009-08-25 12:39:42', '', 'no', 'yes', 4, 'sitellite_page', 'index', 'fr', '2009-08-25 12:39:42', 'no', 'approved', 'Accueil', 'a:4:{s:5:"title";s:24:"Bienvenue sur Sitellite!";s:9:"nav_title";s:7:"Accueil";s:11:"description";s:55:"Bienvenue sur votre nouvelle installation de Sitellite.";s:4:"body";s:931:"<p>Si vous lisez ceci, cela signifie que vous avez correctement installÃ© le systÃ¨me de gestion de contenu (SGC) Sitellite, une puissante plateforme PHP pour la gestion de contenu et le dÃ©veloppement d''applications web. Ceci est le site web exemple qui est installÃ© avec le SGC Sitellite. Son but est de fournir une instroduction au systÃ¨me et de vous aider Ã  franchir les prochaines Ã©tapes vers la rÃ©alisation d''un vÃ©ritable site web fonctionnant sous Sitellite.</p>\r\n\r\n<p>Pour commencer Ã  Ã©diter votre site web, entrez dans la boÃ®te qui se trouve Ã  gauche, le nom d''usager "admin" et le mot de passe que vous avez choisi durant l''installation. L''interface complÃ¨te de Sitellite apparaÃ®tra. Vous pouvez aussi vous connecter en allant Ã  "www.example.com/sitellite" sur votre site web.</p>\r\n\r\n<p>Nous espÃ©rons que vous apprÃ©cierez votre visite de Sitellite.</p>\r\n\r\n<p>-- L''Ã©quipe Simian<br />\r\n\r\n</p>\r\n\r\n<br />\r\n\r\n";}'),
(5, 'admin', 'created', '2009-08-18 20:04:44', '', 'no', 'yes', 5, 'sitellite_sidebar', 'support', 'fr', '2009-08-18 20:04:44', 'no', 'approved', 'Des questions?', 'a:3:{s:5:"title";s:14:"Des questions?";s:8:"position";s:4:"left";s:4:"body";s:172:"<p>Envoyez-nous un courriel Ã  <a href="mailto:info@simian.ca">info@simian.ca</a>, ou tÃ©lÃ©phonez au 1-204-221-6837 entre 9h et 17h CST, du lundi au vendredi<br />\r\n</p>\r\n";}'),
(6, 'admin', 'created', '2009-08-25 15:12:33', '', 'no', 'yes', 6, 'sitellite_page', 'next', 'fr', '2009-08-25 15:12:33', 'no', 'approved', 'Pour poursuivre...', 'a:2:{s:5:"title";s:18:"Pour poursuivre...";s:4:"body";s:2373:"<p>Maintenant que vous avez rÃ©ussi Ã  installer correctement le SGC Sitellite et que vous avez pu vous familiariser avec son fonctionnement, vous devez vous demander: qu''est-ce que je fais maintenant?</p>\r\n<p>Ne vous en faites pas, nous avons prÃ©parÃ© pour vous une liste qui devrait vous aider Ã  dÃ©marrer le plus rapidement possible.</p>\r\n<h2><a href="http://www.sitellite.org/" target="_blank">Visitez Sitellite.org\r\n    </a></h2>\r\n<p>C''est le site officiel de Sitellite, sur lequel vous trouverez des ressources telles:</p>\r\n<ul><li>Le manuel de l''utilisateur de Sitellite, qui contient plusieurs pages de documentation professionnelle pour l''usager, et des exemples introductifs pas-Ã -pas.</li>\r\n<li>Des tutoriels, des cours et plus encore, pour aider les designers et les dÃ©veloppeurs Ã  construire de super sites web en utilisant Sitellite. Les tutoriels sont adaptÃ©s Ã  des niveaux qui vont du dÃ©butant Ã  l''expert.</li>\r\n<li>Des nouvelles sur les produits pour Ãªtre mis au courant quand de nouvelles versions et de nouveaux dÃ©veloppements de Sitellite surviennent.</li>\r\n<li>Des forums de discussion oÃ¹ vous pouvez joindre des conversations actives avec d''autres usagers de SItellite, pour obtenir de l''aide rapidement, ou simplement pour partager des idÃ©es.</li>\r\n<li>Des outils et des produits tiers pour augmenter les capacitÃ©s de SItellite de maniÃ¨re toujours croissante.</li>\r\n</ul>\r\n<h2><a href="http://www.simian.ca/" target="_blank">Visitez Simian Systems\r\n    </a></h2>\r\n<p>Nous sommes la compagnie se trouvant derriÃ¨re Sitellite. Nous sommes lÃ  pour vous fournir un large Ã©ventail de services et de produits spÃ©cialisÃ©s, incluant:</p>\r\n<ul><li>Forfaits de support technique aux heures ouvrables ou 24x7.</li>\r\n<li>Formation sur des sujets tels Sitellite, la gestion de contenu, Linux/Apache/MySQL/PHP, la sÃ©curitÃ© des applications web, les standards web, et plus encore.</li>\r\n<li>Des services de personalisation et de dÃ©veloppement -- qui de mieux placÃ©s que les dÃ©veloppeurs de Sitellite pour vous aider Ã  dÃ©velopper la prochaine application du tonnerre?</li>\r\n<li>Licences commerciales et Ã©dition entreprise du systÃ¨me de gestion de contenu Sitellite, pour les revendeurs et les dÃ©veloppeurs d''applications qui ne veulent pas Ãªtre restreints par les temes de licence GPL.</li>\r\n<li>Et plus...<br />\r\n</li>\r\n</ul>\r\n<br />\r\n";}');
