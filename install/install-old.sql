...
INSERT INTO sitellite_page VALUES ('manual','User Manual (PDF)','','','','no','','approved','public',NULL,NULL,'admin','development','http://www.sitellite.org/inc/app/org/downloads/sitellite-4.2-user-manual.pdf','yes','yes',4,'','','<br />\r\n');
...
INSERT INTO sitellite_page_sv VALUES (7, 'admin', 'created', now(), '', 'no', 'yes', 'manual','User Manual (PDF)','','','','no','','approved','public',NULL,NULL,'admin','development','http://www.sitellite.org/inc/app/org/downloads/sitellite-4.2-user-manual.pdf','yes','yes',4,'','','<br />\r\n');
