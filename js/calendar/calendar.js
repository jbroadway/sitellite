...
// $Id: calendar.js,v 1.1.1.1 2005/04/29 04:44:34 lux Exp $
...
Calendar.prototype.create = function (_par) {
	...
	if (this.isPopup) {
		...
		// LUX> Forces calendar above all elements, even raised ones (unless raised higher)
		// Perhaps a better solution would be to inherit the z-index (+1) of the element
		// that the calendar is attached to...
