<?php
// $Id: bug-561101.php,v 1.1.1.1 2005/04/29 04:44:37 lux Exp $
...
* @version   $Revision: 1.1.1.1 $ ($Date: 2005/04/29 04:44:37 $),
...
class ClubBase extends PEAR {
    ...
    */
    function ClubBase() {
        $this->_PHPDOCUMENTOR_DEBUG("Initialisiere Klasse " . get_class($this), PHPDOCUMENTOR_DEBUG_CTRACE);
	$this->PEAR();
    }
    ...
    */
	...
	$class = (isset($this)) ? get_class($this) ."($called) -" : '';
	if($level <= $blevel) {
