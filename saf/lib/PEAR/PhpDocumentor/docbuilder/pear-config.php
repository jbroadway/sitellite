...
<script type="text/javascript">
	...
	<div class="tab-page" id="tab_config">
		...
		<tr>
			...
			<td width="100%">
<form name="configForm" action="config.php" method="get">
				<input size="20" type="text" name="altuserdir" value="" /><input type="SUBMIT" value="Change" name="submitButton">
		<?php
			if (!empty($_REQUEST['altuserdir'])) {
		...
		<tr>
			...
			<td>
<form name="dataForm" action="builder.php" method="get" onsubmit="return validate()" target="OutputFrame">
...
?>
	...
	<div class="tab-page" id="tab_credits">
		...
		<!-- hhmts start -->
		<pre>
		Last modified: $Date: 2005/04/29 04:44:36 $
