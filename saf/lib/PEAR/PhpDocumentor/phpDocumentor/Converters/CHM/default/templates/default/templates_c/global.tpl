...
</CODE> [line <span class="linenumber"><?php if ($this->_tpl_vars['globals'][$this->_sections['glob']['index']]['slink']): ?><?php echo $this->_tpl_vars['globals'][$this->_sections['glob']['index']]['slink']; ?>
