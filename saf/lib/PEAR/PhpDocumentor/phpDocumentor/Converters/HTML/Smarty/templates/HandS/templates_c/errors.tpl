...
<?php endfor; endif; ?>
<?php if (count((array)$this->_tpl_vars['all'])):
    foreach ((array)$this->_tpl_vars['all'] as $this->_tpl_vars['file'] => $this->_tpl_vars['issues']):
?>
...
$this->_sections['warnings']['loop'] = is_array($this->_tpl_vars['issues']['warnings']) ? count($this->_tpl_vars['issues']['warnings']) : max(0, (int)$this->_tpl_vars['issues']['warnings']);
...
$this->_sections['errors']['loop'] = is_array($this->_tpl_vars['issues']['errors']) ? count($this->_tpl_vars['issues']['errors']) : max(0, (int)$this->_tpl_vars['issues']['errors']);
