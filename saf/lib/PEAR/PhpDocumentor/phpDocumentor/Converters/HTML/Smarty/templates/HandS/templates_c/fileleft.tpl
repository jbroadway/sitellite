...
<?php if (count((array)$this->_tpl_vars['fileleftindex'])):
    foreach ((array)$this->_tpl_vars['fileleftindex'] as $this->_tpl_vars['subpackage'] => $this->_tpl_vars['files']):
?>
  <div class="package">
...
<?php if ($this->_tpl_vars['files'][$this->_sections['files']['index']]['link'] != ''): ?></a><?php endif; ?></span><br />
	<?php endfor; endif; ?>
  </div>
