...
array('modifier', 'capitalize', 'filetags.tpl', 4, false),)); ?><?php if (count ( $this->_tpl_vars['tags'] ) > 0): ?>
...
?>
		<tr><td><strong><?php echo $this->_run_mod_handler('capitalize', true, $this->_tpl_vars['tags'][$this->_sections['tag']['index']]['keyword']); ?>
