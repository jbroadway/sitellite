<?php /* Smarty version 2.5.0, created on 2003-07-02 15:09:41
...
</span>&nbsp;&nbsp;<span class="smalllinenumber">[line <?php if ($this->_tpl_vars['functions'][$this->_sections['func']['index']]['slink']): ?><?php echo $this->_tpl_vars['functions'][$this->_sections['func']['index']]['slink']; ?>
...
$this->_smarty_include("docblock.tpl", array('sdesc' => $this->_tpl_vars['functions'][$this->_sections['func']['index']]['sdesc'],'desc' => $this->_tpl_vars['functions'][$this->_sections['func']['index']]['desc']));
...
<br />
	<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include("tags.tpl", array('api_tags' => $this->_tpl_vars['functions'][$this->_sections['func']['index']]['api_tags'],'info_tags' => $this->_tpl_vars['functions'][$this->_sections['func']['index']]['info_tags']));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
