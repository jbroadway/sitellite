<?php /* Smarty version 2.5.0, created on 2003-06-05 01:25:49
...
">
	...
	<div>
		<span class="include-title">
			...
			<span class="smalllinenumber">[line <?php if ($this->_tpl_vars['includes'][$this->_sections['includes']['index']]['slink']): ?><?php echo $this->_tpl_vars['includes'][$this->_sections['includes']['index']]['slink']; ?>
...
unset($_smarty_tpl_vars);
 ?>
	<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include("tags.tpl", array('api_tags' => $this->_tpl_vars['includes'][$this->_sections['includes']['index']]['api_tags'],'info_tags' => $this->_tpl_vars['includes'][$this->_sections['includes']['index']]['info_tags']));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
