<?php /* Smarty version 2.5.0, created on 2003-06-05 01:26:10
         compiled from var.tpl */ ?>
<?php $this->_load_plugins(array(
array('function', 'cycle', 'var.tpl', 3, false),
array('modifier', 'replace', 'var.tpl', 9, false),)); ?><?php if (isset($this->_sections['vars'])) unset($this->_sections['vars']);
...
">
	...
	<div class="var-header">
		<span class="var-title">
			...
			<span class="smalllinenumber">[line <?php if ($this->_tpl_vars['vars'][$this->_sections['vars']['index']]['slink']): ?><?php echo $this->_tpl_vars['vars'][$this->_sections['vars']['index']]['slink']; ?>
...
$this->_smarty_include("docblock.tpl", array('sdesc' => $this->_tpl_vars['vars'][$this->_sections['vars']['index']]['sdesc'],'desc' => $this->_tpl_vars['vars'][$this->_sections['vars']['index']]['desc']));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
	<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include("tags.tpl", array('api_tags' => $this->_tpl_vars['vars'][$this->_sections['vars']['index']]['api_tags'],'info_tags' => $this->_tpl_vars['vars'][$this->_sections['vars']['index']]['info_tags']));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
