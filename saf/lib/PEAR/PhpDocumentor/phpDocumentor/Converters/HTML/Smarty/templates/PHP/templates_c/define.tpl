...
"></a>
 ...
 <span class="smalllinenumber">[line <?php if ($this->_tpl_vars['defines'][$this->_sections['def']['index']]['slink']): ?><?php echo $this->_tpl_vars['defines'][$this->_sections['def']['index']]['slink']; ?>
