<?php /* Smarty version 2.5.0, created on 2003-04-23 16:55:42
         compiled from method.tpl */ ?>
<?php $this->_load_plugins(array(
array('modifier', 'default', 'method.tpl', 36, false),)); ?><?php if (isset($this->_sections['methods'])) unset($this->_sections['methods']);
...
"></a>
	<h3><?php if ($this->_tpl_vars['methods'][$this->_sections['methods']['index']]['ifunction_call']['constructor']): ?>constructor <?php elseif ($this->_tpl_vars['methods'][$this->_sections['methods']['index']]['ifunction_call']['destructor']): ?>destructor <?php else: ?>method <?php endif; ?><?php echo $this->_tpl_vars['methods'][$this->_sections['methods']['index']]['function_name']; ?>
 <span class="smalllinenumber">[line <?php if ($this->_tpl_vars['methods'][$this->_sections['methods']['index']]['slink']): ?><?php echo $this->_tpl_vars['methods'][$this->_sections['methods']['index']]['slink']; ?>
