<?php /* Smarty version 2.5.0, created on 2003-08-19 11:36:33
         compiled from global.tpl */ ?>
<?php $this->_load_plugins(array(
array('modifier', 'replace', 'global.tpl', 17, false),)); ?><?php if (count ( $this->_tpl_vars['globals'] ) > 0): ?>
 ...
 ?>
  ...
  <table border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td><?php echo $this->_run_mod_handler('replace', true, $this->_run_mod_handler('replace', true, $this->_run_mod_handler('replace', true, $this->_tpl_vars['globals'][$this->_sections['glob']['index']]['global_value'], ' ', "&nbsp;"), "\n", "<br />\n"), "\t", "&nbsp;&nbsp;&nbsp;"); ?>
</td>
    </tr>
