<?php /* Smarty version 2.5.0, created on 2003-06-02 17:53:40
...
) <span class="linenumber">[line <?php if ($this->_tpl_vars['includes'][$this->_sections['includes']['index']]['slink']): ?><?php echo $this->_tpl_vars['includes'][$this->_sections['includes']['index']]['slink']; ?>
