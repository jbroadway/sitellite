...
{section name=index loop=$index}
	...
	{section name=contents loop=$index[index].index}
		<dt class="field">
			...
			<img src="{$subdir}media/images/{if $index[index].index[contents].constructor}Constructor{elseif $index[index].index[contents].destructor}Destructor{elseif $index[index].index[contents].access == 'private'}Private{$index[index].index[contents].title}{else}{$index[index].index[contents].title}{/if}.png" alt="{$index[index].index[contents].title}" title="{$index[index].index[contents].title}" /></title>
