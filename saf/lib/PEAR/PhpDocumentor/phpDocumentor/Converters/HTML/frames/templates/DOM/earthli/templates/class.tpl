		...
		<div class="info-box-body">			
			<div class="method-summary">
				...
				<div class="method-definition">
					<img src="{$subdir}media/images/{if $methods[methods].ifunction_call.constructor}Constructor{elseif $methods[methods].ifunction_call.destructor}Destructor{elseif $methods[methods].access == 'private'}PrivateMethod{else}Method{/if}.png" alt=" "/>
				...
				{section name=imethods loop=$imethods}
					...
					<blockquote>
						{section name=im2 loop=$imethods[imethods].imethods}
							<img src="{$subdir}media/images/{if $imethods[imethods].imethods[im2].constructor}Constructor{elseif $imethods[imethods].ifunction_call.destructor}Destructor{elseif $imethods[imethods].imethods[im2].access == 'private'}PrivateMethod{else}Method{/if}.png" />
