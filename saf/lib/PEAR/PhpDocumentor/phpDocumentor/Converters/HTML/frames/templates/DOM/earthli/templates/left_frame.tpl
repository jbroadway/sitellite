	...
	{if $info[p].subpackage == ""}
		...
		{if $info[p].classes}
			...
			{section name=class loop=$info[p].classes}
				...
				classe.openIcon = 'media/images/{if $info[p].classes[class].access == 'private'}Private{/if}Class.png';
				classe.icon = 'media/images/{if $info[p].classes[class].access == 'private'}Private{/if}Class.png';
