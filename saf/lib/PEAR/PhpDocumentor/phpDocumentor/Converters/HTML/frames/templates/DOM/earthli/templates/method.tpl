...
<div class="{cycle values="evenrow,oddrow"}">
	...
	<div class="method-header">
		<img src="{$subdir}media/images/{if $methods[methods].ifunction_call.constructor}Constructor{elseif $methods[methods].ifunction_call.destructor}Destructor{elseif $methods[methods].access == 'private'}PrivateMethod{else}Method{/if}.png" />
