<?php /* Smarty version 2.5.0, created on 2003-04-23 15:36:58
...
');
				classe.openIcon = 'media/images/<?php if ($this->_tpl_vars['info'][$this->_sections['p']['index']]['classes'][$this->_sections['class']['index']]['access'] == 'private'): ?>Private<?php endif; ?>Class.png';
				classe.icon = 'media/images/<?php if ($this->_tpl_vars['info'][$this->_sections['p']['index']]['classes'][$this->_sections['class']['index']]['access'] == 'private'): ?>Private<?php endif; ?>Class.png';
