<?php /* Smarty version 2.5.0, created on 2003-04-23 13:28:46
...
?>				
				<div class="method-definition">
					<img src="<?php echo $this->_tpl_vars['subdir']; ?>
media/images/<?php if ($this->_tpl_vars['methods'][$this->_sections['methods']['index']]['ifunction_call']['constructor']): ?>Constructor<?php elseif ($this->_tpl_vars['methods'][$this->_sections['methods']['index']]['ifunction_call']['destructor']): ?>Destructor<?php elseif ($this->_tpl_vars['methods'][$this->_sections['methods']['index']]['access'] == 'private'): ?>PrivateMethod<?php else: ?>Method<?php endif; ?>.png" alt=" "/>
...
?>
							<img src="<?php echo $this->_tpl_vars['subdir']; ?>
media/images/<?php if ($this->_tpl_vars['imethods'][$this->_sections['imethods']['index']]['imethods'][$this->_sections['im2']['index']]['constructor']): ?>Constructor<?php elseif ($this->_tpl_vars['imethods'][$this->_sections['imethods']['index']]['ifunction_call']['destructor']): ?>Destructor<?php elseif ($this->_tpl_vars['imethods'][$this->_sections['imethods']['index']]['imethods'][$this->_sections['im2']['index']]['access'] == 'private'): ?>PrivateMethod<?php else: ?>Method<?php endif; ?>.png" />
