<?php /* Smarty version 2.5.0, created on 2003-04-23 13:36:22
...
media/images/<?php if ($this->_tpl_vars['info'][$this->_sections['p']['index']]['classes'][$this->_sections['class']['index']]['access'] == 'private'): ?>Private<?php endif; ?>Class.png" alt="Class"><a href='<?php echo $this->_tpl_vars['info'][$this->_sections['p']['index']]['classes'][$this->_sections['class']['index']]['link']; ?>
...
$this->_sections['f']['loop'] = is_array($this->_tpl_vars['info'][$this->_sections['p']['index']]['functions']) ? count($this->_tpl_vars['info'][$this->_sections['p']['index']]['functions']) : max(0, (int)$this->_tpl_vars['info'][$this->_sections['p']['index']]['functions']);
