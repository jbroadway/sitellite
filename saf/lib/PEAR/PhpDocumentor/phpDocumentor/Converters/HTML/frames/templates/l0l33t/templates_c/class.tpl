<?php /* Smarty version 2.5.0, created on 2003-04-23 14:04:13
...
unset($_smarty_tpl_vars);
 ?>
		<p class="notes">
			Located in <span class="field"><?php echo $this->_tpl_vars['source_location']; ?>
</span> (line <span class="field"><?php if ($this->_tpl_vars['class_slink']): ?><?php echo $this->_tpl_vars['class_slink']; ?>
