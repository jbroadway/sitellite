<?php /* Smarty version 2.5.0, created on 2003-04-23 14:04:14
         compiled from define.tpl */ ?>
<?php $this->_load_plugins(array(
array('function', 'cycle', 'define.tpl', 3, false),
array('modifier', 'replace', 'define.tpl', 7, false),)); ?><?php if (isset($this->_sections['def'])) unset($this->_sections['def']);
