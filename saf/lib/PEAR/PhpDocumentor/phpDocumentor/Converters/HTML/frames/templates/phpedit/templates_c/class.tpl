<?php /* Smarty version 2.5.0, created on 2003-04-23 16:13:47
...
<!-- Start of Class Data -->
<h2>
	Class <?php echo $this->_tpl_vars['class_name']; ?>

</h2> (line <span class="linenumber"><?php if ($this->_tpl_vars['class_slink']): ?><?php echo $this->_tpl_vars['class_slink']; ?>
