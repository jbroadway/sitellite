...
array('function', 'cycle', 'function.tpl', 9, false),)); ?><!-- ============ FUNCTION DETAIL =========== -->
...
</strong> (line <span class="linenumber"><?php if ($this->_tpl_vars['functions'][$this->_sections['func']['index']]['slink']): ?><?php echo $this->_tpl_vars['functions'][$this->_sections['func']['index']]['slink']; ?>
...
</i> <strong><?php if ($this->_tpl_vars['functions'][$this->_sections['func']['index']]['ifunction_call']['returnsref']): ?>&amp;<?php endif; ?><?php echo $this->_tpl_vars['functions'][$this->_sections['func']['index']]['function_name']; ?>
(
