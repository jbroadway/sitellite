<?php /* Smarty version 2.5.0, created on 2003-06-02 17:36:29
         compiled from method.tpl */ ?>
<?php $this->_load_plugins(array(
array('function', 'cycle', 'method.tpl', 25, false),
array('modifier', 'default', 'method.tpl', 47, false),)); ?><h2 class="tab">Method Detail</h2>
<!-- ============ METHOD DETAIL =========== -->
...
media/images/<?php if ($this->_tpl_vars['methods'][$this->_sections['methods']['index']]['ifunction_call']['constructor']): ?>Constructor<?php elseif ($this->_tpl_vars['methods'][$this->_sections['methods']['index']]['ifunction_call']['destructor']): ?>Destructor<?php else: ?>PublicMethod<?php endif; ?>.gif" border="0" /> <strong class="method"><?php if ($this->_tpl_vars['methods'][$this->_sections['methods']['index']]['ifunction_call']['constructor']): ?>Constructor <?php elseif ($this->_tpl_vars['methods'][$this->_sections['methods']['index']]['ifunction_call']['destructor']): ?>Destructor <?php else: ?>Method <?php endif; ?><?php echo $this->_tpl_vars['methods'][$this->_sections['methods']['index']]['function_name']; ?>
</strong> (line <span class="linenumber"><?php if ($this->_tpl_vars['methods'][$this->_sections['methods']['index']]['slink']): ?><?php echo $this->_tpl_vars['methods'][$this->_sections['methods']['index']]['slink']; ?>
...
</i> <strong><?php if ($this->_tpl_vars['methods'][$this->_sections['methods']['index']]['ifunction_call']['returnsref']): ?>&amp;<?php endif; ?><?php echo $this->_tpl_vars['methods'][$this->_sections['methods']['index']]['function_name']; ?>
(
<?php if (count ( $this->_tpl_vars['methods'][$this->_sections['methods']['index']]['ifunction_call']['params'] )): ?>
<?php if (isset($this->_sections['params'])) unset($this->_sections['params']);
$this->_sections['params']['name'] = 'params';
