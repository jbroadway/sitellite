<?php /* Smarty version 2.5.0, created on 2003-07-27 20:47:12
         compiled from function.tpl */ ?>
<?php $this->_load_plugins(array(
array('modifier', 'rawurlencode', 'function.tpl', 4, false),)); ?><?php ob_start(); ?>Function <?php echo $this->_tpl_vars['intricatefunctioncall']['name']; ?>
<?php $this->_smarty_vars['capture']['flink'] = ob_get_contents(); ob_end_clean(); ?>
<?php ob_start(); ?><?php echo $this->_tpl_vars['intricatefunctioncall']['name']; ?>
()|||<?php echo $this->_tpl_vars['sdesc']; ?>
<?php $this->_smarty_vars['capture']['findex'] = ob_get_contents(); ob_end_clean(); ?>
...
<?php endif; ?>]</i><C:rf:3<?php echo $this->_run_mod_handler('rawurlencode', true, $this->_smarty_vars['capture']['flink']); ?>
><C:index:<?php echo $this->_run_mod_handler('rawurlencode', true, $this->_smarty_vars['capture']['findex']); ?>
></text>