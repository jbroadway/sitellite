...
// +----------------------------------------------------------------------+
//
// $Id: XML_HTMLSax_States.php,v 1.1.1.1 2005/04/29 04:44:43 lux Exp $
//
/**
* Main parser components
* @package XML_HTMLSax
* @version $Id: XML_HTMLSax_States.php,v 1.1.1.1 2005/04/29 04:44:43 lux Exp $
*/
/**
    ...
    */
    function parse(&$context) {
        ...
        if ($tag != '') {
            ...
            $context->handler_object_element->
                {$context->handler_method_opening}($context->htmlsax, $tag, $this->attrs);
            $char = $context->scanCharacter();
            if ($char == '/') {
                $char = $context->scanCharacter();
                if ($char != '>') {
